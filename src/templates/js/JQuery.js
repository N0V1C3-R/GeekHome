...
*/
        (function (window) {
                var i, support, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput,
                    ...
                    contains, expando = "sizzle" + 1 * new Date(), preferredDoc = window.document, dirruns = 0,
                    done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(),
    ...
    jQuery.extend({
        cssHooks: {
            ...
            "zIndex": true,
            "zoom": true
        }, cssProps: {}, style: function (elem, name, value, extra) {
    ...
    jQuery.extend({
        ...
        ajaxSettings: {
            ...
            converters: {
                "* text": String, "text html": true, "text json": JSON.parse, "text xml": jQuery.parseXML
            },
            flatOptions: {
    ...
    jQuery._evalUrl = function (url, options) {
        return jQuery.ajax({
            url: url, type: "GET", dataType: "script", cache: true, async: false, global: false, converters: {
    ...
    jQuery.parseHTML = function (data, context, keepScripts) {
        ...
        if (self.length > 0) {
            jQuery.ajax({
                url: url, type: type || "GET", dataType: "html", data: params
    ...
    jQuery.fn.extend({
        offset: function (options) {
            ...
            if (jQuery.css(elem, "position") === "fixed") {
                ...
                while (offsetParent && (offsetParent === doc.body || offsetParent === doc.documentElement) && jQuery.css(offsetParent, "position") === "templates") {
